...
0000000000400efc <phase_2>:
  ...
  400f02:	48 89 e6             	mov    %rsp,%rsi                  ;rsp放到第二个参数去
  400f05:	e8 52 05 00 00       	callq  40145c <read_six_numbers>  ;   看到这里后来就没看了，比较前用gdb打印，就能看到要用什么比什么，就知道正确答案了，跟开挂差不多
...
0000000000401062 <phase_5>:
  ...
  401099:	0f b6 92 b0 24 40 00 	movzbl 0x4024b0(%rdx),%edx        ;0x4024b0是"maduiersnfotvbylSo you think you can stop the bomb with ctrl-c, do you?"。0x4024b0+0x48是"Curses, you've found the secret phase!"。0x4024b0+0x70是"But finding it and solving it are quite different..."。0x4024b0+0xa8是"Congratulations! You've defused the bomb!"。0x4024b0 + 0xd2
0x402582是"Well..."
  ...
  4010b8:	48 8d 7c 24 10       	lea    0x10(%rsp),%rdi            ;第一题没有这一步
  4010bd:	e8 76 02 00 00       	callq  401338 <strings_not_equal>
  4010c2:	85 c0                	test   %eax,%eax                  ;相等的话rax为0
...
00000000004010f4 <phase_6>:
  ...
  40110e:	41 bc 00 00 00 00    	mov    $0x0,%r12d
    ...
    401132:	44 89 e3             	mov    %r12d,%ebx
      ...
      401148:	83 fb 05             	cmp    $0x5,%ebx             ;循环5次
  ...
  4011da:	bd 05 00 00 00       	mov    $0x5,%ebp
    ...
    4011f2:	83 ed 01             	sub    $0x1,%ebp              ;循环5次
...
000000000040145c <read_six_numbers>:
  40145c:	48 83 ec 18          	sub    $0x18,%rsp                       ;分配24字节空间
  401460:	48 89 f2             	mov    %rsi,%rdx                        ;之前把rsp放到rsi（第2个参数），现在把rsi放到放到rdx
  401463:	48 8d 4e 04          	lea    0x4(%rsi),%rcx                   ;把rsi加4放到rcx（第4个参数）
  401467:	48 8d 46 14          	lea    0x14(%rsi),%rax                  ;把rsi加20放到rax返回值
  40146b:	48 89 44 24 08       	mov    %rax,0x8(%rsp)                   ;把返回值移到rsp+8
